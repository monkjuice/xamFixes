...
using xamFixes.Droid.Renders;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using FAB = Android.Support.Design.Widget.FloatingActionButton;


[assembly: ExportRenderer(typeof(xamFixes.Controls.FloatingActionButton), typeof(FloatingActionButtonRenderer))]
namespace xamFixes.Droid.Renders
{
    public class FloatingActionButtonRenderer : Xamarin.Forms.Platform.Android.AppCompat.ViewRenderer<Controls.FloatingActionButton, FAB>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<xamFixes.Controls.FloatingActionButton> e)
        {
